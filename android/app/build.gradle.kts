...
// Pins the Java toolchain so JdkImageTransform gets javaCompiler.metadata.installationPath
// (full JDK with jlink) instead of falling back to java.home from an IDE-managed JRE.
kotlin {
    jvmToolchain(17)
}
